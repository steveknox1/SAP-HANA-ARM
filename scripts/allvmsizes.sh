...
then
  ...
  echo "not 51052325"
    ...
    then
      hanapackage="51053061"
if [ "${HANAVER}" = "SAP HANA PLATFORM EDITION 2.0 SPS04 REV 46 (51054413)" ]
then
  hanapackage="51054413"
    else
...
/usr/bin/wget --quiet "https://raw.githubusercontent.com/steveknox1/SAP-HANA-ARM/master/hdbinst.cfg"
